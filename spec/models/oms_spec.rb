...
RSpec.describe OMS, type: :model do
  ...
  context "#projects" do
    ...
    let(:default_oms) do
      create(:oms, offers: [create(:offer),
    ...
    let(:oms) do
      create(:oms, default: true, offers: [create(:offer, project_items: [create(:project_item, project: project1)]),
                                           create(:offer,
                                                  project_items: [create(:project_item, project: project1)])])
    end
