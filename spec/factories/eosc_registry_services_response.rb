        ...
        "results" => [
          {
            "service" => {
              ...
              "tagline" => tagline,
              "description" =>
                "<p>PhenoMeNal (Phenome and Metabolome aNalysis) is a comprehensive and standardised e-infrastructure
                that supports the data processing and analysis pipelines for molecular phenotype data generated by
          ...
          },
          {
            "service" => {
              ...
              "tagline" => "",
              "description" =>
                "Knowledge on metal sites in biological macromolecules, built on structural information
          ...
          },
          {
            "service" => {
              ...
              "tagline" => "",
              "description" =>
                "The PDB_REDO web server allows users to optimise their crystallographic structure model in
                an automated way. The model is refined and rebuilt in the context of the experimental data.
                The server returns a new structure model, new electron density maps, validation data, a script
                to visualise model changes in COOT, and a settings file for further model refinement in REFMAC.",
              "targetUsers" => "",
