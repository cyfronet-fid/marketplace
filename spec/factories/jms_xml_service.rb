        ...
        "resource" => "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>
          <tns:infraService xmlns:tns=\"http://einfracentral.eu\">
            ...
            <tns:service>
              ...
              <tns:description>&lt;p style=\"text-align: justify;\"&gt;A catalogue of corpora (datasets)
                made up of mainly Open Access scholarly publications.&lt;br /&gt; Users can view publicly available
                corpora that have been created with the OpenMinTeD Corpus Builder for Scholarly Works, or manually
                ...
                that compose them.&amp;nbsp;&lt;/p&gt; &lt;p style=\"text-align: justify;\"&gt;In addition, registered
                users can process them with the TDM applications offered by OpenMinTeD and download them in accordance
                with their licensing conditions.&lt;/p&gt;</tns:description>
