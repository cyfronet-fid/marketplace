...
FactoryBot.define do
  factory :eosc_registry_vocabularies_response, class: Hash do
    ...
    initialize_with do
      ...
      next {
        "PROVIDER_SOCIETAL_GRAND_CHALLENGE" => [{ "id" => "provider_societal_grand_challenge-energy",
                                                     "name" => "Energy",
                                                     "description" => "Secure, clean and efficient energy.",
                                                     "parentId" => nil,
                                                     "type" => "Provider societal grand challenge",
                                                     "extras" => {} }],
        "PROVIDER_ESFRI_TYPE" => [{ "id" => "provider_esfri_type-landmark",
                                    "name" => "Landmark",
                                    "description" => "RI is an ESFRI landmark",
                                    "parentId" => nil,
                                    "type" => "Provider esfri type",
                                    "extras" => {} }],
        "PROVIDER_LIFE_CYCLE_STATUS" => [{ "id" => "provider_life_cycle_status-being_upgraded",
                                           "name" => "Being Upgraded",
                                           "description" => "The Research Infrastructure is currently being upgraded.",
                                           "parentId" => nil,
                                           "type" => "Provider life cycle status",
                                           "extras" => {} }],
        "LIFE_CYCLE_STATUS" => [{ "id" => "life_cycle_status-alpha",
                                  "name" => "Alpha",
                                  "description" => "Resource prototype available for closed set of users",
                                  "parentId" => nil,
                                  "type" => "Life cycle status",
                                  "extras" => {} }],
        "SCIENTIFIC_SUBDOMAIN" => [{ "id" => "scientific_subdomain-agricultural_sciences-agricultural_biotechnology",
        ...
        "COUNTRY" => [{ "id" => "AD",
                        ...
                        "type" => "Country",
                        "extras" => {} }],
        "FUNDING_PROGRAM" => [{ "id" => "funding_program-afis2020",
                                "name" => "Anti Fraud Information System (AFIS2020)",
                                "description" => nil,
                                "parentId" => nil,
                                "type" => "Funding program",
                                "extras" => {} }],
        "PROVIDER_AREA_OF_ACTIVITY" => [{ "id" => "provider_area_of_activity-applied_research",
        ...
        "SUBCATEGORY" => [{ "id" => "subcategory-access_physical_and_eInfrastructures-compute-container_management",
                            "name" => "Container Management", "description" => nil,
                            "parentId" => "category-access_physical_and_eInfrastructures-compute",
                            "type" => "Subcategory",
                            "extras" => {} }],
        "SCIENTIFIC_DOMAIN" => [{ "id" => "scientific_domain-agricultural_sciences",
                                  "name" => "Agricultural Sciences",
                                  "description" => "Sciences dealing with food and fibre production and processing.",
                                  "parentId" => nil,
                                  "type" => "Scientific domain",
                                  "extras" => { "icon": "ic_analytics.svg", "icon_active": "ic_analytics_active.svg" } }],
        "TRL" => [{ "id" => "trl-1",
                    ...
                    "extras" => {} }],
        "PROVIDER_LEGAL_STATUS" => [{ "id" => "provider_legal_status-association",
                                      "name" => "Association",
                                      "description" => nil,
                                      "parentId" => nil,
                                      "type" => "Provider legal status",
                                      "extras" => {} }],
        "PROVIDER_NETWORK" => [{ "id" => "provider_network-4c",
