  ...
  describe "POST /api/webhooks/jira" do
    ...
    describe "Voucher ID" do
      ...
      it "should grant voucher ID" do
        data = create(:jira_webhook_response, :voucher_id_change, issue_id: issue_id, issue_status: 6,
                                                                  voucher_id_to: "1234")
    ...
    describe "update_comment" do
      ...
      it "should update comment" do
        data = create(:jira_webhook_response, :comment_update, id: comment_id, issue_id: issue_id,
                                                               message: "New message")
        post(api_webhooks_jira_url + "?secret=secret&issue_id=#{issue_id}", params: data)
