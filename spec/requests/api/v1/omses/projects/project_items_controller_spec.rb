      ...
      response 200, "project items found" do
        ...
        let!(:project_items) do
          [
            ...
            create(:project_item, offer: build(:offer, primary_oms: oms), project: project, iid: 2,
        ...
        run_test! do |response|
          ...
          expect(data).to eq({
            project_items: project_items.values_at(1, 3).map do |pi|
              serialized = Api::V1::ProjectItemSerializer.new(pi).as_json
              serialized[:user_secrets] = serialized[:user_secrets].transform_values do |_|
                "<OBFUSCATED>"
              end
              serialized
            end
  ...
  path "/api/v1/oms/{oms_id}/projects/{p_id}/project_items/{pi_id}" do
    ...
    get "retrieves a project item" do
      ...
      response 200, "project item found" do
        ...
        let(:project) { create(:project) }
        let(:project_item) do
          create(:project_item, project: project, user_secrets: { key: "value" },
    ...
    patch "updates a project item" do
      ...
      response 403, "user not authorized" do
        ...
        let(:project_item) do
          create(:project_item, status: "ready", status_type: "ready",
