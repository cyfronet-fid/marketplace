class ChangeResearchAreaToScientificDomain < ActiveRecord::Migration[6.0]
  def change
    remove_index :service_research_areas,
                 name: :index_service_research_areas_on_service_id_and_research_area_id
    remove_index :project_research_areas,
                 name: :index_project_research_areas_on_project_id_and_research_area_id
    remove_index :user_research_areas,
                 name: :index_user_research_areas_on_user_id_and_research_area_id
    ...
    rename_column :service_scientific_domains,
                  :research_area_id, :scientific_domain_id
    rename_column :project_scientific_domains,
                  :research_area_id, :scientific_domain_id
    rename_column :user_scientific_domains,
                  :research_area_id, :scientific_domain_id
    rename_column :users,
