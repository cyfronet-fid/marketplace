class AddMissingFieldsToService < ActiveRecord::Migration[6.0]
  def change
    add_column :services, :resource_geographic_locations,
    ...
    add_column :services, :open_source_technologies,
               :string, array: true, default: []
    add_column :services, :changelog, :string, array: true, default: []
    add_column :services, :grant_project_names,
               :string, array: true, default: []
    add_column :services, :multimedia, :string, array: true, default: []
    add_column :services, :privacy_policy_url, :string
    add_column :services, :use_cases_url, :string
