...
module OrderingApi
  class AuthorizationTestSetup
    ...
    def call
      oms_admin1 = User.create!(uid: "oms2_admin",
                                first_name: "oms2_admin",
                                last_name: "oms2_admin",
                                email: "email1@email.com")
      oms_admin2 = User.create!(uid: "oms3_admin",
      ...
      service2 = Service.create!(name: "s2",
                                 description: "asd",
                                 tagline: "asd",
                                 status: "published",
                                 providers: [provider],
      ...
      project1 = Project.create!(user: project_owner,
                                 name: "p1",
                                 ...
                                 status: "active")
      project2 = Project.create!(user: project_owner,
                                 name: "p2",
                                 email: "email4@email.com",
                                 country_of_origin: "PL",
                                 webpage: "https://www.cyfronet.krakow.pl/",
                                 ...
                                 customer_typology: "single_user",
                                 status: "active")
      project3 = Project.create!(user: project_owner,
                                 name: "p3",
                                 email: "email4@email.com",
                                 country_of_origin: "PL",
                                 webpage: "https://www.cyfronet.krakow.pl/",
      ...
      Message.create!(messageable: project1,
                      author_role: "user",
      ...
      Message.create!(messageable: project3,
