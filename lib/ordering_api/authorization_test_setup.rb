...
module OrderingApi
  class AuthorizationTestSetup
    ...
    def call
      oms_admin1 = User.create!(uid: "oms2_admin", first_name: "oms2_admin", last_name: "oms2_admin",
                                email: "email1@email.com")
      oms_admin2 = User.create!(uid: "oms3_admin", first_name: "oms3_admin", last_name: "oms3_admin",
      ...
      service1 = Service.create!(name: "s1",
                                 description: "asd",
                                 tagline: "asd",
                                 status: "published",
                                 providers: [provider],
      ...
      service2 = Service.create!(name: "s2", description: "asd", tagline: "asd",
                                 status: "published", providers: [provider],
                                 resource_organisation: provider, scientific_domains: [ScientificDomain.first],
                                 geographical_availabilities: ["PL"])
      ...
      project1 = Project.create!(user: project_owner, name: "p1", email: "email4@email.com",
                                 country_of_origin: "PL", webpage: "https://www.cyfronet.krakow.pl/",
                                 organization: "asd", reason_for_access: "asd",
                                 customer_typology: "single_user", status: "active")
      ...
      Message.create!(messageable: project1, author_role: "user", author: project_owner, scope: "public",
                      message: "Public user message in project 1")
      Message.create!(messageable: project1, author_role: "mediator", scope: "public",
                      message: "Public mediator  message in project 1")

      Message.create!(messageable: project3, author_role: "provider", scope: "public",
                      message: "Public provider message in project3")
      Message.create!(messageable: project3, author_role: "provider", scope: "user_direct",
