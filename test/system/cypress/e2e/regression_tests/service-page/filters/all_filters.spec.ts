describe("All filters", () => {
  ...
  it("should select filter and enter phrase in main searchbar", () => {
    ...
    cy.location("href").should("match", /(?=.*providers)/);
    cy.get("[data-e2e='filter-tag']").should("be.visible").and("have.length", 1);
