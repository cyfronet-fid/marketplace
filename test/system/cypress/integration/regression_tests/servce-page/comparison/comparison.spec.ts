describe("Comparison", () => {
  ...
  it("should add and remove services from comparison - services from the catalogue page", () => {
    ...
    cy.get("[data-e2e='compare-btn']")
      .click();
    cy.wait("@comparisonTable");
    cy.location("href")
      .should("include", "/comparisons");
    
    cy.get("[data-e2e='services-comparison-table']")
      .should("be.visible")
    cy.get("[data-e2e='delete-service-btn'] svg")
      .should("have.length", 3)
      .eq(0)
      .click()
   
    cy.wait("@comparisonTable");
    cy.get("[data-e2e='add-next-resource-btn']")
      .click();
    cy.location("href")
      .should("include", "/services");

    
    cy.get("[data-e2e='comparison-clearAll-btn']")
      .click();
    cy.get("[data-e2e='comparison-bar']")
  ...
  it("should add and remove services from comparison - services from details page", () => {
    ...
    cy.get("[data-e2e='delete-service-btn']")
