...
describe("My profile", () => {
  ...
  it("should add and remove Additional information", () => {
    ...
    cy.get("[data-e2e='submit-btn']")
      .click();
    cy.get("[data-e2e='category-item'] li")
      .should("have.length", 2);
    cy.get("[data-e2e='scientific-domain-item'] li")
      .should("have.length", 1);

    cy.get("[data-e2e='additional-inf-edit']")
      .click();
    cy.get(".user_scientific_domains .choices__button")
  ...
  it("should add and remove Email notifications", () => {
    ...
    cy.get("#user_categories_updates")
      .click();
    cy.get("#user_scientific_domains_updates")
      .click();
    cy.get("[data-e2e='submit-btn']")
      .click();
    cy.get("[data-e2e='email-notif-item'] li")
      .should("have.length", 2);
