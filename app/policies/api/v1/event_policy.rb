    ...
    def resolve
      if user.default_oms_administrator?
        ...
        scope.where(offers: { primary_oms_id: user.administrated_oms_ids })
             ...
             .or(scope.where(offers_project_items2: { primary_oms_id: user.administrated_oms_ids }))
             .or(scope.where(offers_project_items3: { primary_oms_id: user.administrated_oms_ids }))
