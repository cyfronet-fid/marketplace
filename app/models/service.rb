...
class Service < ApplicationRecord
  ...
  DETAIL_FIELDS_1 = [{ name: "basic",
                       template: "array",
                       fields: ["version", "last_update", "order_type"],
                       with_desc: true },
                     { name: "classification",
                       template: "array",
                       fields: ["categories", "scientific_domains", "tag_list"],
                       with_desc: true },
                     { name: "location",
                       template: "array",
                       fields: ["geographical_availabilities", "resource_geographic_locations"],
                       with_desc: true },
                     { name: "multimedia",
                       template: "links",
  ...
  DETAIL_FIELDS_2 = [{ name: "public_contacts",
                     ...
                     { name: "maturity_information",
                       template: "array",
                       fields: ["life_cycle_status", "certifications"],
                       with_desc: true },
                    {  name: "other",
                       template: "array",
                       fields: ["related_platforms", "standards", "open_source_technologies"],
                       with_desc: true },
